      ...
      <div className="section-container">
        <CardGroup>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>Kionnali Living Systems Ltd</Card.Text>
              <LearnMore1 />
            </Card.Body>
            <Card.Footer>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>Raising two children.</Card.Text>
              <LearnMore2 />
            </Card.Body>
            <Card.Footer>
        ...
        <CardGroup>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>Lloyds Banking Group</Card.Text>
              <LearnMore4 />
            </Card.Body>
            <Card.Footer>
        ...
        <CardGroup>
          <Card>
            ...
            <Card.Body>
              <Card.Title>
                BA(<em>Hons</em>) Marketing & Communications
              </Card.Title>
              <Card.Text>Glasgow Caledonian University</Card.Text>
              <LearnMore5 />
            </Card.Body>
            <Card.Footer>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text>General Assembly</Card.Text>
              <LearnMore6 />
            </Card.Body>
            <Card.Footer>
